...
class HideUnhideView(ui.View):
    ...
    async def unhide(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:icons_channel:1408865872386461737> **Channel**: {self.channel.mention}\n<:tick:1408864444796370995> **Status**: Unhidden\n <:Commands:1408864951027761243>**Reason:** Unhide request by {self.author}",
            color=0x000000
        )
        embed.add_field(name="<:U_admin:1408865099615043648> **Moderator:**", value=self.ctx.author.mention, inline=False)
