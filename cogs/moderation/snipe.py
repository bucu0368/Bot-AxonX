...
class SnipeView(discord.ui.View):
    ...
    async def send_snipe_embed(self, interaction: discord.Interaction):
        ...
        if snipe['content']:
            embed.add_field(name="<:delete:1408862413515657217> **Content:**", value=snipe['content'])
    ...
    @discord.ui.button(emoji="<:forward:1408862612825051257>", style=discord.ButtonStyle.secondary, custom_id="first")
    async def first_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.index = 0
        self.update_buttons()
        await self.send_snipe_embed(interaction)

    @discord.ui.button(emoji="<:rewind:1408862201925730414>", style=discord.ButtonStyle.secondary, custom_id="previous")
    ...
    @discord.ui.button(emoji="<:delete:1408862413515657217>", style=discord.ButtonStyle.danger, custom_id="delete")
    async def delete_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.message.delete()

    @discord.ui.button(emoji="<:forward:1408862612825051257>", style=discord.ButtonStyle.secondary, custom_id="next")
    ...
    @discord.ui.button(emoji="<:rewind:1408862201925730414>", style=discord.ButtonStyle.secondary, custom_id="last")
...
class Snipe(commands.Cog):
    ...
    async def snipe(self, ctx):
        ...
        if first_snipe['content']:
            embed.add_field(name="<:delete:1408862413515657217> **Content:**", value=first_snipe['content'])
