...
class Block(commands.Cog):
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1408864444796370995> User Blacklisted",
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:olympus_cross:1409174365349740555> User Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1408864444796370995> User Unblacklisted",
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:CrossIcon:1408869030172819527> No Blacklisted Users",
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<:CrossIcon:1408869030172819527> Guild Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1408864444796370995> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:CrossIcon:1408869030172819527> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1408864444796370995> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:CrossIcon:1408869030172819527> No Blacklisted Guilds",
